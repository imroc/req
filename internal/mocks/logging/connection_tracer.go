...
// Source: github.com/imroc/req/v3/internal/logging (interfaces: ConnectionTracer)
...
import (
	...
	protocol "github.com/imroc/req/v3/internal/protocol"
	utils "github.com/imroc/req/v3/internal/utils"
	wire "github.com/imroc/req/v3/internal/wire"
	logging "github.com/imroc/req/v3/internal/logging"
)
...
func (m *MockConnectionTracer) NegotiatedVersion(arg0 quic.VersionNumber, arg1, arg2 []quic.VersionNumber) {
	m.ctrl.T.Helper()
...
func (m *MockConnectionTracer) ReceivedVersionNegotiationPacket(arg0 *wire.Header, arg1 []quic.VersionNumber) {
	m.ctrl.T.Helper()
