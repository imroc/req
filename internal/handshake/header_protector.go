...
func hkdfHeaderProtectionLabel(v quic.VersionNumber) string {
...
func newHeaderProtector(suite *qtls.CipherSuiteTLS13, trafficSecret []byte, isLongHeader bool, v quic.VersionNumber) headerProtector {
