...
func getSalt(v quic.VersionNumber) []byte {
...
func NewInitialAEAD(connID protocol.ConnectionID, pers protocol.Perspective, v quic.VersionNumber) (LongHeaderSealer, LongHeaderOpener) {
...
func computeSecrets(connID protocol.ConnectionID, v quic.VersionNumber) (clientSecret, serverSecret []byte) {
...
func computeInitialKeyAndIV(secret []byte, v quic.VersionNumber) (key, iv []byte) {
