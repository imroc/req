...
import (
	...
	"github.com/imroc/req/v3/internal/logging"
	...
	"github.com/imroc/req/v3/internal/wire"
...
func newConn(local, remote net.Addr, version quic.VersionNumber) ConnWithVersion {
	return &conn{
		localAddr:  local,
		remoteAddr: remote,
		version:    version,
...
func (c *conn) GetQUICVersion() quic.VersionNumber { return c.version }
