...
func parseStreamsBlockedFrame(r *bytes.Reader, _ quic.VersionNumber) (*StreamsBlockedFrame, error) {
...
func (f *StreamsBlockedFrame) Write(b *bytes.Buffer, _ quic.VersionNumber) error {
	switch f.Type {
...
func (f *StreamsBlockedFrame) Length(_ quic.VersionNumber) protocol.ByteCount {
