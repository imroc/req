...
func parseMaxStreamsFrame(r *bytes.Reader, _ quic.VersionNumber) (*MaxStreamsFrame, error) {
...
func (f *MaxStreamsFrame) Write(b *bytes.Buffer, _ quic.VersionNumber) error {
	switch f.Type {
...
func (f *MaxStreamsFrame) Length(quic.VersionNumber) protocol.ByteCount {
