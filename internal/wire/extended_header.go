...
func (h *ExtendedHeader) parse(b *bytes.Reader, v quic.VersionNumber) (bool /* reserved bits valid */, error) {
	startLen := b.Len()
...
func (h *ExtendedHeader) parseLongHeader(b *bytes.Reader, _ quic.VersionNumber) (bool /* reserved bits valid */, error) {
...
func (h *ExtendedHeader) parseShortHeader(b *bytes.Reader, _ quic.VersionNumber) (bool /* reserved bits valid */, error) {
...
func (h *ExtendedHeader) Write(b *bytes.Buffer, ver quic.VersionNumber) error {
...
func (h *ExtendedHeader) writeLongHeader(b *bytes.Buffer, version quic.VersionNumber) error {
...
func (h *ExtendedHeader) writeShortHeader(b *bytes.Buffer, _ quic.VersionNumber) error {
...
func (h *ExtendedHeader) GetLength(v quic.VersionNumber) protocol.ByteCount {
	if h.IsLongHeader {
