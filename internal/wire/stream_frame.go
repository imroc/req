...
func parseStreamFrame(r *bytes.Reader, _ quic.VersionNumber) (*StreamFrame, error) {
...
func (f *StreamFrame) Write(b *bytes.Buffer, version quic.VersionNumber) error {
...
func (f *StreamFrame) Length(version quic.VersionNumber) protocol.ByteCount {
...
func (f *StreamFrame) MaxDataLen(maxSize protocol.ByteCount, version quic.VersionNumber) protocol.ByteCount {
	...
	if protocol.ByteCount(headerLen) > maxSize {
		return 0
	}
	maxDataLen := maxSize - protocol.ByteCount(headerLen)
...
func (f *StreamFrame) MaybeSplitOffFrame(maxSize protocol.ByteCount, version quic.VersionNumber) (*StreamFrame, bool /* was splitting required */) {
