...
func Is0RTTPacket(b []byte) bool {
	...
	version := quic.VersionNumber(binary.BigEndian.Uint32(b[1:5]))
...
func (h *Header) parseLongHeader(b *bytes.Reader) error {
	...
	h.Version = quic.VersionNumber(v)
...
func (h *Header) ParseExtended(b *bytes.Reader, ver quic.VersionNumber) (*ExtendedHeader, error) {
