...
func parseCryptoFrame(r *bytes.Reader, _ quic.VersionNumber) (*CryptoFrame, error) {
...
func (f *CryptoFrame) Write(b *bytes.Buffer, _ quic.VersionNumber) error {
	b.WriteByte(0x6)
...
func (f *CryptoFrame) Length(_ quic.VersionNumber) protocol.ByteCount {
...
func (f *CryptoFrame) MaybeSplitOffFrame(maxSize protocol.ByteCount, version quic.VersionNumber) (*CryptoFrame, bool /* was splitting required */) {
