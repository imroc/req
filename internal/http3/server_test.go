...
func newMockConn(version quic.VersionNumber) net.Conn {
	return &mockConn{version: version}
}

func (c *mockConn) GetQUICVersion() quic.VersionNumber {
	return c.version
}
...
var _ = Describe("Server", func() {
	...
	Context("setting http headers", func() {
		BeforeEach(func() {
			s.QuicConfig = &quic.Config{Versions: []quic.VersionNumber{protocol.VersionDraft29}}
		})
