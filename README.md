...
* **HTTP Fingerprinting**: Support http fingerprint impersonation, so that we can access websites that prohibit crawler programs by identifying http fingerprints (See [TLS Fingerprinting](https://req.cool/docs/tutorial/http-fingerprint/)).
